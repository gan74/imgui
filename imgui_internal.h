...
namespace ImGui
{
    ...
    IMGUI_API ImVec2        GetWorkRectMin();
    ...
    IMGUI_API void          UpdateColumnData(ImGuiColumns* columns, int column_index);
    IMGUI_API void          SetColumnOutput(ImGuiColumns* columns, int column_index);
